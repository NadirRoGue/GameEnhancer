========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: extender_test_project 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL extender_test_project.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación extender_test_project.


extender_test_project.vcxproj
...
extender_test_project.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado extender_test_project.pch y un archivo de tipos 
